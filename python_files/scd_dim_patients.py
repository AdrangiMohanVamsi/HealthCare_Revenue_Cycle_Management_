...
# CONFIG
# ------------------------------
PROJECT_ID = "rcm-project-467805"  # 🔁 Change this to your actual GCP project ID
...
# LOAD NEW DATA
# ------------------------------
new_data = pd.read_csv("combined_cleaned_patients.csv")  # Replace with your actual cleaned file path
...
# Generate a hash of key attributes to detect changes
def hash_row(row):
...
# Prepare updated old records (expire them)
...
# Prepare new records (new or updated)
